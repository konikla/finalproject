...
?>
 ...
 <p> Hello!
  Fill the following information to get started</p>
...
if ($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if (empty($_POST["weight"]) || empty($_POST["height"]) || empty($_POST["age"]) || empty($_POST["gender"]) || empty($_POST["activity"]) || empty($_POST["goal"]) || empty($_POST["month"])) {
        ...
        echo " <br>  <strong> Fill out all forms! </strong>";

    } else if  (isset($_POST["weight"]) && isset($_POST["height"]) && isset($_POST["age"]) && isset($_POST["gender"]) && isset($_POST["activity"]) && isset($_POST["goal"]) && isset($_POST["month"])) {
...
$query = "INSERT INTO calorycalc2 (userid, date ,weight, activity, energy, goal, month) VALUES($id[0], '$nowDate', $weight, $activity, $value, '$goal', $month)";
